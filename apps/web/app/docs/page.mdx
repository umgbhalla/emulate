...
Local drop-in replacement for Vercel, GitHub, Google, Discord, Slack, Apple, Microsoft, AWS, Okta, Clerk, MongoDB Atlas, Resend, and Stripe APIs. Built for CI and no-network sandboxes. Fully stateful, production-fidelity API emulation. Not mocks.
