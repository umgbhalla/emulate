...
Gateway WebSocket connections, inbound slash-command interaction simulation, and OAuth install flows are not implemented in the native Discord engine yet.
